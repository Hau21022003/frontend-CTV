...
const HomePage: React.FC = () => {
  ...
  const dpmId = user?.department?.departmentId;
  ...
  const [selectedDepartmentName, setSelectedDepartmentName] =
    useState<string>("");
  const [selectedDepartmentNameLv2, setSelectedDepartmentNameLv2] =
    useState<string>("");
  const [selectedDepartmentNameLv3, setSelectedDepartmentNameLv3] =
    useState<string>("");
  const [selectedDepartmentNameLv4, setSelectedDepartmentNameLv4] =
    useState<string>("");
  ...
  //     // Xóa danh sách đơn vị cấp 2 khi chọn lại đơn vị cấp 1
  //     setDepartmentsLv2([]);
  //     setSelectedDepartmentNameLv2(""); // Reset tên đơn vị cấp 2 đã chọn
  //     setDepartmentsLv3([]);
  ...
  //       );
  //       console.log("dpmLV2222222", response.data);
  //       if (response.data) {
  //         setDepartmentsLv2(response.data);
  //       }
  //     } catch (error) {
  ...
  //     }
  //   } else {
  //     // Nếu không có đơn vị cấp 1 được chọn, reset luôn đơn vị cấp 2
  //     setDepartmentsLv2([]);
  //     setSelectedDepartmentNameLv2("");
  //   }
  // };
